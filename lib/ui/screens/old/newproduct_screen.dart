...
import 'package:sougou_app/ui/screens/old/productsScreen.dart';
...
class NewProduct extends StatefulWidget {
  ...
  const NewProduct({Key? key, this.siModifie = false, this.siNouveau = false}) : super(key: key);
...
class _NewProductState extends State<NewProduct> {
  ...
  libelleReduit,
  motDirecteur,
  marqueId,origineId,secteurId,rayonId,familleId,sousFamilleId;
  bool? statut,siReactive;
  bool isStatut = false;
  //bool isModifie = false;
  //bool isNouveau = false;
  ...
  setConstDropdownValues() {
    ...
    discountTypeList.addAll([
      CommonDropDownItem("amount", "Fixe"),
      CommonDropDownItem("percent", "Pourcentage"),
    ]);
    selectedProductDiscountType = discountTypeList.first;
    selectedFlashDiscountType = discountTypeList.first;
    //selectedSecteur = secteurs.first;
 ...
 /* pickGalleryImages() async {
  ...
  Future<void> submitProduct(String button) async {
    ...
    try {
      ...
      final response = await ProductRepository().postProducts(postBody);
